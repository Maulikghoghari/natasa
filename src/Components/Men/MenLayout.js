...
const filters = {
  ...
  priceRanges: [
    { label: "$24.00 - $26.00", min: 24, max: 26 },
    { label: "$36.00 - $37.00", min: 36, max: 37 },
    { label: "$47.00 - $51.00", min: 47, max: 51 },
    { label: "$59.00 - $61.00", min: 59, max: 61 },
    { label: "$78.00 - $81.00", min: 78, max: 81 },
    { label: "$89.00 - $93.00", min: 89, max: 93 },
    { label: "$94.00 - $96.00", min: 94, max: 96 },
  ]
};

function MenLayout({ selectedRange, setSelectedRange }) {
